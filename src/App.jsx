...
const APIS = [
  ...
  {id:"gemini-pro",name:"Gemini 2.5 Pro",badge:"Free",type:"google",
   model:"gemini-2.5-pro",color:"#fb923c",
   keyUrl:"https://aistudio.google.com/apikey",
  ...
  {id:"qwq-groq",name:"QwQ 32B",badge:"Free · Think",type:"groq",
   model:"qwen-qwq-32b",color:"#60a5fa",
   keyUrl:"https://console.groq.com/keys",
   desc:"Qwen's reasoning model on Groq. Thinks step-by-step, great for hard coding problems."},
