          ...
          {tab==="api"&&<>
            ...
            <div className="s-sec">
              ...
              {curApi.type==="anthropic"&&<>
                <div className="s-note">✓ No key needed — Claude runs automatically via the artifact proxy.</div>
              </>}
              {curApi.type==="google"&&<>
            ...
            <div className="msgs-in">
              ...
              {error&&(["no_openrouter_key","no_google_key","no_groq_key"].includes(error)?(()=>{
                const cfg={
                  ...
                  no_openrouter_key:{emoji:"🔑",name:"OpenRouter",url:"https://openrouter.ai/keys",label:"Get free OpenRouter key"},
                }[error];
                return (
